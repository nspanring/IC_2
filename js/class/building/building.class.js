...
class Building extends Entity {
  constructor(id, x,y,floors = 1, size = 100){
    ...
    this.x = x;
    this.y = y;
    this.grid_x = parseInt(Animation.grid.getGrid(this.x, this.y).split(",")[0]);
		this.grid_y = parseInt(Animation.grid.getGrid(this.x, this.y).split(",")[1]);
